...
export class SetDefaultForNeedsApproval1600872863349
  implements MigrationInterface {
  name = 'SetDefaultForNeedsApproval1600872863349';
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `provider` CHANGE `needsApproval` `needsApproval` tinyint NOT NULL',
      undefined,
    );
    await queryRunner.query(
