...
export class AddImageToCourse1589374454100 implements MigrationInterface {
  name = 'AddImageToCourse1589374454100';

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      'DROP INDEX `IDX_d01838ce93b4508b98f8b0e529` ON `provider`',
      undefined,
    );
    await queryRunner.query(
      'CREATE TABLE `course_images` (`id` int NOT NULL AUTO_INCREMENT, `url` varchar(100) NOT NULL, `key` varchar(100) NOT NULL, `courseId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` ADD `profileImageId` int NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` ADD UNIQUE INDEX `IDX_f3715ccea3ac76c3f7e4e844a1` (`profileImageId`)',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE UNIQUE INDEX `REL_f3715ccea3ac76c3f7e4e844a1` ON `course` (`profileImageId`)',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'DROP INDEX `REL_f3715ccea3ac76c3f7e4e844a1` ON `course`',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `course` DROP INDEX `IDX_f3715ccea3ac76c3f7e4e844a1`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` DROP COLUMN `profileImageId`',
      undefined,
    );
    await queryRunner.query('DROP TABLE `course_images`', undefined);
    await queryRunner.query(
      'CREATE UNIQUE INDEX `IDX_d01838ce93b4508b98f8b0e529` ON `provider` (`profileImageId`)',
      undefined,
    );
  }
}
