...
export class addMaxParticipantsToCourse1603716604195
  implements MigrationInterface {
  name = 'addMaxParticipantsToCourse1603716604195';

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      'ALTER TABLE `course` ADD `maxParticipants` int NULL',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `course` DROP COLUMN `maxParticipants`',
      undefined,
    );
  }
}
