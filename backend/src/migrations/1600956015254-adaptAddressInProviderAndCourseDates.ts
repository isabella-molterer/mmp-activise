...
export class adaptAddressInProviderAndCourseDates1600956015254
  implements MigrationInterface {
  name = 'adaptAddressInProviderAndCourseDates1600956015254';
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `provider` ADD `addressId` int NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `provider` ADD UNIQUE INDEX `IDX_68378f4e8775dc843848881e1d` (`addressId`)',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `provider` DROP INDEX `IDX_68378f4e8775dc843848881e1d`',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "ALTER TABLE `address` ADD `providerId` int NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
