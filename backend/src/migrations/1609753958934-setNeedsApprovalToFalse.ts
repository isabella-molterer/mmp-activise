...
export class setNeedsApprovalToFalse1609753958934
  implements MigrationInterface {
  name = 'setNeedsApprovalToFalse1609753958934';
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `provider` CHANGE `needsApproval` `needsApproval` tinyint NOT NULL DEFAULT 0',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      "ALTER TABLE `provider` CHANGE `needsApproval` `needsApproval` tinyint NOT NULL DEFAULT '1'",
      undefined,
    );
    await queryRunner.query(
