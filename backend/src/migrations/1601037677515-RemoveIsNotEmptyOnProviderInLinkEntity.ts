...
export class RemoveIsNotEmptyOnProviderInLinkEntity1601037677515
  implements MigrationInterface {
  name = 'RemoveIsNotEmptyOnProviderInLinkEntity1601037677515';

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      'DROP INDEX `IDX_c0304246aaf83f8e2c7ddae4db` ON `address`',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'CREATE UNIQUE INDEX `IDX_c0304246aaf83f8e2c7ddae4db` ON `address` (`providerId`)',
      undefined,
    );
  }
}
