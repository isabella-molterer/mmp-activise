...
export class AddImageToMember1589374736168 implements MigrationInterface {
  name = 'AddImageToMember1589374736168';

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      'DROP INDEX `IDX_f3715ccea3ac76c3f7e4e844a1` ON `course`',
      undefined,
    );
    await queryRunner.query(
      'CREATE TABLE `member_image` (`id` int NOT NULL AUTO_INCREMENT, `url` varchar(100) NOT NULL, `key` varchar(100) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `member` ADD `profileImageId` int NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `member` ADD UNIQUE INDEX `IDX_7468f42e33e79d30fc83eea33e` (`profileImageId`)',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE UNIQUE INDEX `REL_7468f42e33e79d30fc83eea33e` ON `member` (`profileImageId`)',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `provider_images` ADD CONSTRAINT `FK_53321f5f6ad2282251c190872a5` FOREIGN KEY (`providerId`) REFERENCES `course`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'DROP INDEX `REL_7468f42e33e79d30fc83eea33e` ON `member`',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `member` DROP INDEX `IDX_7468f42e33e79d30fc83eea33e`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `member` DROP COLUMN `profileImageId`',
      undefined,
    );
    await queryRunner.query('DROP TABLE `member_image`', undefined);
    await queryRunner.query(
      'CREATE UNIQUE INDEX `IDX_f3715ccea3ac76c3f7e4e844a1` ON `course` (`profileImageId`)',
      undefined,
    );
  }
}
