...
export class AddCascades1585816292426 implements MigrationInterface {
  name = 'AddCascades1585816292426';
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `course` ADD `phoneNumber` varchar(25) NOT NULL',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `course` DROP COLUMN `phoneNumber`',
      undefined,
    );
    await queryRunner.query(
