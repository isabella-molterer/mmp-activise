...
export class updateAddressEntityAndAddAddressToCourseDate1601022567244
  implements MigrationInterface {
  name = 'updateAddressEntityAndAddAddressToCourseDate1601022567244';
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'DROP INDEX `IDX_68378f4e8775dc843848881e1d` ON `provider`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_date` DROP COLUMN `addressId`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_date` ADD `street` varchar(100) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_date` ADD `zip` varchar(25) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_date` ADD `city` varchar(35) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_date` ADD `country` varchar(25) NOT NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `instructor` `instructor` varchar(50) NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `phoneNumber` `phoneNumber` varchar(25) NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `difficulty` `difficulty` varchar(25) NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `equipment` `equipment` varchar(255) NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `requirements` `requirements` varchar(255) NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `provider` DROP FOREIGN KEY `FK_68378f4e8775dc843848881e1d1`',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `provider` CHANGE `phoneNumber` `phoneNumber` varchar(25) NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `provider` CHANGE `addressId` `addressId` int NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `provider` ADD CONSTRAINT `FK_68378f4e8775dc843848881e1d1` FOREIGN KEY (`addressId`) REFERENCES `address`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      "ALTER TABLE `provider` CHANGE `addressId` `addressId` int NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
      "ALTER TABLE `provider` CHANGE `phoneNumber` `phoneNumber` varchar(25) NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "ALTER TABLE `course` CHANGE `requirements` `requirements` varchar(255) NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
      "ALTER TABLE `course` CHANGE `equipment` `equipment` varchar(255) NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
      "ALTER TABLE `course` CHANGE `difficulty` `difficulty` varchar(25) NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      "ALTER TABLE `course` CHANGE `phoneNumber` `phoneNumber` varchar(25) NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
      "ALTER TABLE `course` CHANGE `instructor` `instructor` varchar(50) NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` ADD CONSTRAINT `FK_f3715ccea3ac76c3f7e4e844a15` FOREIGN KEY (`profileImageId`) REFERENCES `course_images`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION',
    ...
    await queryRunner.query(
      'ALTER TABLE `course_date` DROP COLUMN `country`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_date` DROP COLUMN `city`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_date` DROP COLUMN `zip`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_date` DROP COLUMN `street`',
      undefined,
    );
    await queryRunner.query(
      "ALTER TABLE `course_date` ADD `addressId` int NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
      'CREATE UNIQUE INDEX `IDX_68378f4e8775dc843848881e1d` ON `provider` (`addressId`)',
      undefined,
    );
    await queryRunner.query(
