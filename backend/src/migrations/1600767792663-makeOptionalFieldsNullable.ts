...
export class makeOptionalFieldsNullable1600767792663
  implements MigrationInterface {
  name = 'makeOptionalFieldsNullable1600767792663';
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `provider` CHANGE `phoneNumber` `phoneNumber` varchar(25) NOT NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `requirements` `requirements` varchar(255) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `equipment` `equipment` varchar(255) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `difficulty` `difficulty` varchar(25) NOT NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `phoneNumber` `phoneNumber` varchar(25) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `instructor` `instructor` varchar(50) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` ADD CONSTRAINT `FK_f3715ccea3ac76c3f7e4e844a15` FOREIGN KEY (`profileImageId`) REFERENCES `course_images`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION',
