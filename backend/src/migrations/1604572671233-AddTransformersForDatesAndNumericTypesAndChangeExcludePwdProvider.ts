...
export class AddTransformersForDatesAndNumericTypesAndChangeExcludePwdProvider1604572671233
  implements MigrationInterface {
  name =
    'AddTransformersForDatesAndNumericTypesAndChangeExcludePwdProvider1604572671233';
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `price` `price` decimal(7,2) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course` CHANGE `maxParticipants` `maxParticipants` int NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `provider` CHANGE `price` `price` decimal(7,2) NOT NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `course_images` ADD CONSTRAINT `FK_cb3b7c0000fe2852eb9ac290b07` FOREIGN KEY (`courseId`) REFERENCES `course`(`id`) ON DELETE SET NULL ON UPDATE NO ACTION',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      "ALTER TABLE `course` CHANGE `maxParticipants` `maxParticipants` int NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
