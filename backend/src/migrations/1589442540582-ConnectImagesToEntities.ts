...
export class ConnectImagesToEntities1589442540582
  implements MigrationInterface {
  name = 'ConnectImagesToEntities1589442540582';

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      'DROP INDEX `IDX_7468f42e33e79d30fc83eea33e` ON `member`',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'CREATE UNIQUE INDEX `IDX_7468f42e33e79d30fc83eea33e` ON `member` (`profileImageId`)',
      undefined,
    );
  }
}
