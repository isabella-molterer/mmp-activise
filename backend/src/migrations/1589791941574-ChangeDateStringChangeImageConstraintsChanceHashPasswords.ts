...
export class ChangeDateStringChangeImageConstraintsChanceHashPasswords1589791941574
  implements MigrationInterface {
  name =
    'ChangeDateStringChangeImageConstraintsChanceHashPasswords1589791941574';
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `course_images` DROP COLUMN `url`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_images` ADD `url` varchar(255) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_images` DROP COLUMN `key`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_images` ADD `key` varchar(255) NOT NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `member_image` DROP COLUMN `url`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `member_image` ADD `url` varchar(255) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `member_image` DROP COLUMN `key`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `member_image` ADD `key` varchar(255) NOT NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `provider_images` DROP COLUMN `url`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `provider_images` ADD `url` varchar(255) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `provider_images` DROP COLUMN `key`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `provider_images` ADD `key` varchar(255) NOT NULL',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'ALTER TABLE `provider_images` ADD `key` varchar(100) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `provider_images` DROP COLUMN `url`',
    ...
    await queryRunner.query(
      'ALTER TABLE `provider_images` ADD `url` varchar(100) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `provider_images` ADD CONSTRAINT `FK_53321f5f6ad2282251c190872a5` FOREIGN KEY (`providerId`) REFERENCES `provider`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION',
    ...
    await queryRunner.query(
      'ALTER TABLE `member_image` ADD `key` varchar(100) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `member_image` DROP COLUMN `url`',
    ...
    await queryRunner.query(
      'ALTER TABLE `member_image` ADD `url` varchar(100) NOT NULL',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `course_images` ADD `key` varchar(100) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_images` DROP COLUMN `url`',
    ...
    await queryRunner.query(
      'ALTER TABLE `course_images` ADD `url` varchar(100) NOT NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `course_images` ADD CONSTRAINT `FK_cb3b7c0000fe2852eb9ac290b07` FOREIGN KEY (`courseId`) REFERENCES `course`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION',
    ...
    await queryRunner.query(
      'ALTER TABLE `member` ADD CONSTRAINT `FK_7468f42e33e79d30fc83eea33e7` FOREIGN KEY (`profileImageId`) REFERENCES `member_image`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `course` ADD CONSTRAINT `FK_f3715ccea3ac76c3f7e4e844a15` FOREIGN KEY (`profileImageId`) REFERENCES `course_images`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION',
      undefined,
    );
    await queryRunner.query(
