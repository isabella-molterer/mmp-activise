...
export class AdaptProviderAddressRelation1601027205574
  implements MigrationInterface {
  name = 'AdaptProviderAddressRelation1601027205574';
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'DROP INDEX `REL_68378f4e8775dc843848881e1d` ON `provider`',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `address` ADD `providerId` int NULL',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `address` ADD UNIQUE INDEX `IDX_c0304246aaf83f8e2c7ddae4db` (`providerId`)',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE UNIQUE INDEX `REL_c0304246aaf83f8e2c7ddae4db` ON `address` (`providerId`)',
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      'DROP INDEX `REL_c0304246aaf83f8e2c7ddae4db` ON `address`',
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE `address` DROP INDEX `IDX_c0304246aaf83f8e2c7ddae4db`',
      undefined,
    );
    await queryRunner.query(
      'ALTER TABLE `address` DROP COLUMN `providerId`',
      undefined,
    );
    await queryRunner.query(
      "ALTER TABLE `provider` ADD `addressId` int NULL DEFAULT 'NULL'",
      undefined,
    );
    await queryRunner.query(
      'CREATE UNIQUE INDEX `REL_68378f4e8775dc843848881e1d` ON `provider` (`addressId`)',
      undefined,
    );
    await queryRunner.query(
